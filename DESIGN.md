...
BreadSched-owned planning state must not be destroyed by re-import. Longer-term
separation of imported ledger state from BreadSched classifications/resolutions is
