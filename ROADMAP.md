...
The current released application baseline is **`v0.2.0a99`**; publication of
`v0.2.0a100` depends on the tested main workflow. Alpha releases should carry
GitHub pre-release metadata as well as versioned notes and verified artifacts.
