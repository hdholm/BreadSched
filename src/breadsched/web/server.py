...
class Api:
    ...
    def plan(
        ...
        """Delegate Plan query and response projection to the read-only adapter."""
        return plan_report(
            self.db,
            start_month,
            through_month,
    ...
    def plan_detail(
        ...
        """Explain a Plan cell through the dedicated read-only resource adapter."""
        return plan_detail_report(
            self.db,
            account_handle,
            start_value,
            end_value,
    ...
    def scheduled_save(self, payload: dict) -> dict:
        """Save a fixed schedule through the request adapter and shared service."""
        return save_fixed_schedule_request(self, payload)
